"""
Django settings for music_registry project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-rhz=m@*l=e4@j)a@$lhiyu3p*735l$a#vja^9w6ln!3st2nz7$')
...
MIDDLEWARE = [
    ...
    'classes.middleware.RoleBasedAccessMiddleware',
]

ROOT_URLCONF = 'music_registry.urls'
...
WSGI_APPLICATION = 'music_registry.wsgi.application'
